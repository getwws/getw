...
class FormValidator
{
    ...
    public function addMessage($ruleName,$message = null){
        if(is_array($ruleName)){
            foreach($ruleName as $rule=>$msg){
                $this->_instanceRuleMessage[$rule] = $msg;
            }
        }else{
            $this->_instanceRuleMessage[$ruleName] = $message;
        }
        return $this;
    }
